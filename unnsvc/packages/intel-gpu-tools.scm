(define-module (unnsvc packages intel-gpu-tools)
...
(define-public intel-gpu-tools
  (package
    ...
    (version "867b1a51a6310d63f34acc8ffe602355694da7ee")
    (source
     (origin
       (method git-fetch)
       (uri
        (git-reference
         (url "https://github.com/vsyrjala/intel-gpu-tools.git")
         (commit "867b1a51a6310d63f34acc8ffe602355694da7ee")))
       (file-name (git-file-name name version))
       (sha256
        (base32
         "1vj1h6b0624rvxnf7wgfg17gid9bibskmabw870dr9chccisxf3x"))))
